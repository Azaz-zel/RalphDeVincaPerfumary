        ...
        <div class="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
                ...
                <p class="mt-8 max-w-2xl text-lg leading-8 text-stone-600 dark:text-stone-400">
                    ...
                    Every perfume belongs to a fragrance family. From fresh Citrus
                    and elegant Floral accords to warm Woody and Amber creations,
                    fragrance families help you understand a perfume's personality
                    and discover scents that truly match your preferences.
            ...
            <div class="hidden justify-center lg:flex">
                ...
                <img
                    src="{{ asset('images/academy/families-hero.png') }}"
                    alt="Fragrance Families"
