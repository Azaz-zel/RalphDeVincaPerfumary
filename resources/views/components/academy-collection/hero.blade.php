        ...
        <div class="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
                ...
                <p class="mt-8 max-w-2xl text-lg leading-8 text-stone-600 dark:text-stone-400">
                    ...
                    A great fragrance collection is not about owning as many
                    bottles as possible. Learn how to choose scents that serve
                    different seasons, occasions, moods, and everyday moments
                ...
                <div class="mt-12 flex flex-wrap gap-5">
                    ...
                    <a
                        href="{{ route('academy.application') }}"
            ...
            <div class="hidden justify-center lg:flex">
                ...
                <img
                    src="{{ asset('images/academy/collection-hero.jpg') }}"
                    alt="Fragrance collection"
                    class="h-[600px] w-full max-w-xl rounded-[2rem] object-cover shadow-2xl"
                >
