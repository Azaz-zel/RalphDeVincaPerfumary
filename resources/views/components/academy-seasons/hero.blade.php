    ...
    <div class="mx-auto max-w-screen-2xl px-8 lg:px-12">
        ...
        <div class="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
                ...
                {{-- Breadcrumb --}}
                <nav
                    class="mb-8 flex items-center gap-3 text-sm text-stone-500 dark:text-stone-400">
                ...
                <p
                    ...
                    The perfect fragrance depends on more than personal taste.
                    Weather, temperature, season, and occasion can all influence
                    how a perfume performs and how appropriate it feels.

                </p>

                <p
                    class="mt-5 max-w-2xl text-lg leading-8 text-stone-600 dark:text-stone-400">

                    Learn how to choose fragrances that complement warm summer
                    days, cool winter evenings, everyday activities, formal
            ...
            <div class="hidden justify-center lg:flex">
                ...
                <img
                    src="{{ asset('images/academy/seasons-hero.jpg') }}"
                    alt="Seasons and Occasions"
                    class="max-h-[650px] w-full max-w-xl rounded-[2rem] object-cover shadow-2xl">
